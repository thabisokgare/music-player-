  ...
  const songsHTML = array.map((song) => {
    return `
      <li id="song-${song.id}" class="playlist-song">
        ...
        <button class= "playlist-song-artist"><span class="playlist-song-artist">${song.artist}</span></button>
        <button class= "playlist-song-duration"><span class="playlist-song-duration">${song.duration}</span></button>
